          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[1, 2, 3].map((item) => (
              <div key={item} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                ...
                <div className="p-6">
                  <h3 className="text-xl font-semibold mb-2">Sample Product {item}</h3>
                  <p className="text-gray-600 mb-4">Amazing product description that highlights key features</p>
                  <div className="flex justify-between items-center">
                    <span className="text-2xl font-bold text-blue-600">${(item * 29.99).toFixed(2)}</span>
                    <Link
                      href="/items"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                We are passionate about providing the best online shopping experience. Our platform 
                connects customers with high-quality products from trusted sellers worldwide.
              </p>
              <p className="text-lg text-gray-600 mb-6">
                Founded with the mission to make shopping simple, secure, and enjoyable, we continue 
                to innovate and improve our services every day.
              </p>
              <Link
                href="/items"
            ...
            <div className="bg-gradient-to-br from-blue-100 to-purple-100 rounded-lg p-8 text-center">
              ...
              <div className="text-gray-700 mb-4">Happy Customers</div>
              <div className="text-4xl font-bold text-purple-600 mb-2">5K+</div>
              <div className="text-gray-700 mb-4">Products Available</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center p-6 border rounded-lg hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600 text-sm">Protected transactions with SSL encryption</p>
            </div>
            <div className="text-center p-6 border rounded-lg hover:shadow-md transition-shadow">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                name: "Mike Chen",
                role: "Business Owner",
                text: "ShopApp has become my go-to platform for all business supplies. Reliable and efficient service."
              },
              {
                name: "Emily Davis",
                role: "Fashion Enthusiast",
                text: "Love the variety of products available. The user interface is clean and easy to navigate."
              }
